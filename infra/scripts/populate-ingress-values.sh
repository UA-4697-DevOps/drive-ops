...
echo "  curl -Iv http://web.driveops.dukhota.dev        # expect 301 → HTTPS"
echo "  curl -Iv https://web.driveops.dukhota.dev       # expect 200 OK"
echo "  curl -Iv http://api.driveops.dukhota.dev    # expect 301 → HTTPS"
echo "  curl -Iv https://api.driveops.dukhota.dev/health  # expect 200 OK"
