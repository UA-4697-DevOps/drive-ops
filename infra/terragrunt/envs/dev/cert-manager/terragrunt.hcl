# ==============================================================================
# CERT-MANAGER – TERRAGRUNT STACK (DEV)
# ==============================================================================
# Creates the IRSA role for cert-manager to use DNS-01 challenges via Route53.
# cert-manager itself is deployed via ArgoCD Helm application.
#
# Dependencies:
#   eks     → OIDC provider ARN and URL
